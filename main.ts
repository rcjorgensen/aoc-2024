const day1InputElm = document.getElementById(
  "day1-input",
...
const day1InputSaveBtn = document.getElementById(
  "day1-input-save",
...
const day1Part1Solve = document.getElementById(
  "day1-part1-solve",
) as HTMLButtonElement;
...
const day1Part2Solve = document.getElementById(
  "day1-part2-solve",
) as HTMLButtonElement;
...
const day2InputElm = document.getElementById(
  "day2-input",
) as HTMLTextAreaElement;
...
const day2InputSaveBtn = document.getElementById(
  "day2-input-save",
) as HTMLButtonElement;
...
const day2Part1Solve = document.getElementById(
  "day2-part1-solve",
) as HTMLButtonElement;
...
function safe(line: string): boolean {
  let i = 0;
  for (; line[i] !== " "; ++i) {}
...
const day2Part2Solve = document.getElementById(
  "day2-part2-solve",
) as HTMLButtonElement;
...
function safe2(line: string): boolean {
  let unsafe = 0;
  let i = 0;
  for (; line[i] !== " "; ++i) {}
  let current = parseInt(line.substring(0, i));
